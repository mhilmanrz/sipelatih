...
class ActivityStoreRoleTest extends TestCase
{
    ...
    public function test_pengusul_cannot_store_activity_with_profession_id(): void
    {
        $profession = Profession::create(['name' => 'Perawat', 'code' => 'PRW']);
        $payload = $this->getValidPayload(['profession_id' => $profession->id]);
        ...
        $this->assertDatabaseHas('activities', [
            'activity_name_id' => $this->activityName->id,
            'profession_id' => null, // Forced to null for pengusul
        ]);
    }
    ...
    public function test_pengusul_cannot_update_activity_with_profession_id(): void
    {
        $profession = Profession::create(['name' => 'Perawat', 'code' => 'PRW']);
        $activity = Activity::create(array_merge($this->getValidPayload(['profession_id' => $profession->id]), ['user_id' => $this->superadminUser->id]));
        ...
        $activity->refresh();
        $this->assertNull($activity->profession_id); // Forced to null for pengusul
    }
