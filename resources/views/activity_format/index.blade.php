...
<div class="tw-wrap p-6">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <!-- Table Control Bar -->
        <form method="GET" action="{{ route('activity-formats.index') }}"
            ...
            <div class="flex items-center gap-2">
                <input type="text" name="q" value="{{ request('q') }}"
                    placeholder="Cari Format Kegiatan..."
                        ...
                        <td class="whitespace-nowrap text-sm font-medium text-center space-x-2 border border-gray-200 py-3 px-4">
                            ...
                            <form action="{{ route('activity-formats.destroy', $activityFormat->id) }}" method="POST"
                                ...
                                <button type="submit"
                                    ...
                                    onclick="return confirm('Apakah Anda yakin ingin menghapus Bentuk Kegiatan ini?')" style="background-color: #ef4444;" class="text-white px-3 py-1.5 rounded hover:bg-[#dc2626] text-sm font-semibold transition inline-block">
                                    Hapus
                                </button>
                            </form>
                        </td>
