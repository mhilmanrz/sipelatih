<x-layouts.app>
    <x-slot:title>Tambah Bentuk Kegiatan</x-slot>
    ...
    <div class="tw-wrap p-6 max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-white">TAMBAH BENTUK KEGIATAN BARU</h1>
            <p class="text-gray-300 mt-1">Silakan isi form di bawah ini untuk menambahkan data bentuk kegiatan baru.</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('activity-formats.store') }}" method="POST">
                @csrf
