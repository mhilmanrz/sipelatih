<x-layouts.app>
    ...
    <div class="tw-wrap p-6 max-w-2xl mx-auto">
        <div class="mb-6">
            ...
            <p class="text-gray-600 mt-1">Silakan perbarui form di bawah ini untuk mengubah data metode kegiatan.</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('activity-methods.update', $activityMethod->id) }}" method="POST">
                @csrf
                @method('PUT')

                <div class="mb-4">
                    <label for="code" class="block text-gray-700 font-semibold mb-2">Kode</label>
                    <input type="text" name="code" id="code" value="{{ old('code', $activityMethod->code) }}"
                ...
                <div class="mb-4">
                    <label for="name" class="block text-gray-700 font-semibold mb-2">Nama Metode Kegiatan <span
                            class="text-red-500">*</span></label>
                    <input type="text" name="name" id="name" value="{{ old('name', $activityMethod->name) }}"
