...
@section('title', 'Edit Jenis Tenaga')
...
<div class="tw-wrap p-6 max-w-2xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Edit Data Jenis Tenaga</h1>
        <p class="text-gray-600 mt-1">Silakan perbarui form di bawah ini untuk mengubah data Jenis Tenaga.</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('employment-types.update', $employmentType->id) }}" method="POST">
            ...
            <div class="mb-4">
                <label for="name" class="block text-gray-700 font-semibold mb-2">Nama Jenis Tenaga <span
