<x-layouts.app>
    ...
    <div class="tw-wrap p-6 max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Edit Data Jenis Kepegawaian</h1>
            <p class="text-gray-600 mt-1">Silakan perbarui form di bawah ini untuk mengubah data jenis kepegawaian.</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('employment-types.update', $employmentType->id) }}" method="POST">
                ...
                <div class="mb-4">
                    <label for="code" class="block text-gray-700 font-semibold mb-2">Kode Jenis Kepegawaian <span
                            class="text-red-500">*</span></label>
                    <input type="text" name="code" id="code" value="{{ old('code', $employmentType->code) }}"
                        ...
                        placeholder="Contoh: ASN" required>
                    @error('code')
                ...
                <div class="mb-4">
                    <label for="name" class="block text-gray-700 font-semibold mb-2">Nama Jenis Kepegawaian <span
                            class="text-red-500">*</span></label>
                    <input type="text" name="name" id="name" value="{{ old('name', $employmentType->name) }}"
