...
@section('title', 'Manajemen Jenis Tenaga')
...
<div class="tw-wrap p-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Manajemen Jenis Tenaga</h1>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center space-x-2">
                        ...
                        <form action="{{ route('employment-types.destroy', $employmentType->id) }}" method="POST"
                            ...
                            <button type="submit"
                                ...
                                onclick="return confirm('Apakah Anda yakin ingin menghapus Jenis Tenaga ini?')">
                                Hapus
                            </button>
                        </form>
                    </td>
