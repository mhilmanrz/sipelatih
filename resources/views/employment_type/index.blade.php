<x-layouts.app>
    <x-slot:title>Manajemen Jenis Kepegawaian</x-slot>

    <div class="px-8 py-6">

        {{-- TITLE & BUTTONS --}}
        <div class="flex flex-wrap justify-between items-center gap-4 mb-6">
            <x-page-title>Manajemen Jenis Kepegawaian</x-page-title>
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden mb-6">
                                    ...
                                    <div class="flex justify-center gap-1.5">
                                        ...
                                        <form action="{{ route('employment-types.destroy', $employmentType->id) }}" method="POST"
                                            ...
                                            <button type="submit"
                                                ...
                                                onclick="return confirm('Apakah Anda yakin ingin menghapus Jenis Kepegawaian ini?')">
                                                Hapus
                                            </button>
                                        </form>
                                    </div>
            ...
            <div class="px-5 py-4 border-t border-gray-200">
                {{ $employmentTypes->links('components.pagination') }}
            </div>
        </div>
    </div>
</x-layouts.app>
