                        ...
                        <td class="whitespace-nowrap text-sm font-medium text-center space-x-2 border border-gray-200 py-3 px-4">
                            ...
                            <form action="{{ route('work-units.destroy', $workUnit->id) }}" method="POST"
                                ...
                                <button type="submit"
                                    ...
                                    onclick="return confirm('Apakah Anda yakin ingin menghapus Unit Kerja ini?')" style="background-color: #ef4444;" class="text-white px-3 py-1.5 rounded hover:bg-[#dc2626] text-sm font-semibold transition inline-block">
                                    Hapus
                                </button>
                            </form>
                        </td>
