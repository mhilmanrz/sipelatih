...
@endpush
    ...
    <div class="tw-wrap p-6 max-w-2xl mx-auto">
        <div class="mb-6">
            ...
            <p class="text-gray-600 mt-1">Silakan perbarui form di bawah ini untuk mengubah data profesi.</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('professions.update', $profession->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="code" id="code" value="{{ old('code', $profession->code) }}"
