<x-layouts.app>
    <x-slot:title>Tambah Pangkat</x-slot>
    ...
    <div class="tw-wrap p-6 max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-white">TAMBAH PANGKAT</h1>
            <p class="text-gray-600 mt-1">Silakan isi form di bawah ini untuk menambahkan data pangkat baru.</p>
        </div>
