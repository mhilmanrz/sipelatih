                ...
                <div class="flex flex-col bg-[#113a3a] pb-1">
                    ...
                    @can('view evaluasi')
                        <a href="{{ route('evaluations.dashboard') }}"
                            class="flex items-center pl-8 pr-4 py-2.5 text-gray-200 hover:bg-[#1fd1d1] hover:text-black transition-colors {{ request()->is('evaluations/dashboard*') ? 'bg-[#1fd1d1] text-black border-l-4 border-[#1fd1d1] font-semibold' : '' }}">
