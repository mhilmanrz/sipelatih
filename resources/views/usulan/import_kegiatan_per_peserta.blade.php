...
@section('title', 'Import Kegiatan Per Peserta')
    <div class="p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-xl shadow p-8 border-t-4 border-blue-500">
                <div class="flex items-center gap-4 mb-4">
                    <div class="bg-blue-100 text-blue-600 rounded-full h-12 w-12 flex items-center justify-center font-bold text-xl">1</div>
                    <h2 class="text-xl font-bold text-gray-800">Unduh Format Excel</h2>
                </div>
                
                <p class="text-gray-600 mb-6 leading-relaxed">
                    Template ini berisi format untuk mengunggah Data Kegiatan sekaligus NIP pegawai yang akan ditambahkan sebagai peserta ke dalam kegiatan tersebut.
                </p>

                <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
                    <p class="text-sm text-yellow-700">
                        <strong>Perhatian:</strong> NIP peserta harus terdaftar pada Master Data Pegawai. Jika ada NIP yang tidak terdaftar, maka peserta tersebut tidak dimasukkan ke dalam sistem.
                    </p>
                </div>
            ...
            <div class="bg-white rounded-xl shadow p-8 border-t-4 border-blue-500">
                <div class="flex items-center gap-4 mb-4">
                    <div class="bg-blue-100 text-blue-600 rounded-full h-12 w-12 flex items-center justify-center font-bold text-xl">2</div>
                    <h2 class="text-xl font-bold text-gray-800">Unggah Data Kegiatan per Peserta</h2>
                </div>
                
                <p class="text-gray-600 mb-6">
                    Arahkan file <span class="font-semibold text-gray-800">.xlsx</span> yang sudah Anda lengkapi ke area di bawah ini.
                </p>

                <form action="{{ route('kegiatan.import-per-peserta.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:bg-gray-50 transition-colors">
                        <label for="excel_file" class="cursor-pointer flex flex-col items-center justify-center">
                            <svg class="w-16 h-16 text-blue-500 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 13h6m-3-3v6m5 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
