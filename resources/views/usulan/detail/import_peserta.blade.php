    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-xl shadow p-8 border-t-4 border-teal-500">
            ...
            <p class="text-gray-600 mb-6 leading-relaxed">
                Agar sistem dapat membaca data dengan akurat, mohon gunakan template resmi yang telah kami sediakan. Anda dapat melengkapi informasi NIP, Nama, Email, Password, dan Unit Kerja sesuai kebutuhan.
            </p>

            <div class="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6">
                <p class="text-sm text-blue-700">
                    <strong>Catatan Penting:</strong> Jika NIP / Employee ID belum terdaftar di sistem, aplikasi akan otomatis membuat akun user baru menggunakan data yang Anda tuliskan di Excel tersebut.
                </p>
            </div>
