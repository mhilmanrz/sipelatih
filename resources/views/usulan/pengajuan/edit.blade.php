    ...
    <form method="POST" action="{{ route('kegiatan.update', $kegiatan->id) }}">
        ...
        <div class="form-card">
            ...
            <div class="form-row">
                ...
                <div style="width: 100%;">
                    <input type="number" id="angka" name="batch_id" value="{{ old('batch_id', $kegiatan->batch->name ?? '') }}" required style="width: 100%;">
            ...
            <div class="form-row">
                ...
                <div style="width: 100%;">
                    <input type="text" id="budget_display" value="{{ old('budget_amount', $kegiatan->budget_amount ? floor($kegiatan->budget_amount) : '') }}" required>
                    <input type="hidden" name="budget_amount" id="budget_actual" value="{{ old('budget_amount', $kegiatan->budget_amount ? floor($kegiatan->budget_amount) : '') }}">
                    <small style="color: #666; font-size: 13px; margin-top: 5px; display: block;">*Otomatis berformat ribuan</small>
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <select name="budget_id">
                    ...
                    <option value="{{ $budget->id }}" {{ old('budget_id', $kegiatan->budget_id) == $budget->id ? 'selected' : '' }}>
            ...
            <div class="form-row">
                ...
                <select name="work_unit_id" id="work_unit_id" required>
                    ...
                    <option value="{{ $wu->name }}" {{ old('work_unit_id', $kegiatan->workUnit->name ?? '') == $wu->name ? 'selected' : '' }}>
                        {{ $wu->name }}
                    </option>
                    @endforeach
                </select>
