...
<div class="p-8">
    <div class="mb-6 flex justify-between items-center">
        <h1 class="text-2xl font-bold uppercase" style="color: white; font-size: 1.5rem; background-color: #14b8a6; padding: 1rem 2rem; border-radius: 8px; display: inline-block;">IMPORT KEGIATAN</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-xl shadow p-8 border-t-4 border-teal-500">
            ...
            <p class="text-gray-600 mb-6 leading-relaxed">
                Agar sistem dapat membaca data usulan kegiatan dengan benar, pastikan Anda menggunakan format Excel resmi yang kami sediakan.
            </p>

            <a href="{{ route('kegiatan.import.template') }}" class="inline-flex py-3 px-6 bg-gray-800 hover:bg-gray-900 text-white font-semibold rounded-lg shadow items-center transition-colors">
        ...
        <div class="bg-white rounded-xl shadow p-8 border-t-4 border-teal-500">
            <div class="flex items-center gap-4 mb-4">
                ...
                <h2 class="text-xl font-bold text-gray-800">Unggah Data Kegiatan</h2>
            </div>
            ...
            <form action="{{ route('kegiatan.import.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
