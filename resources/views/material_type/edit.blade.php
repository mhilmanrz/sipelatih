<x-layouts.app>
    <x-slot:title>Edit Jenis Materi</x-slot>
    ...
    <div class="tw-wrap p-6 max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Edit Data Jenis Materi</h1>
            <p class="text-gray-600 mt-1">Silakan perbarui form di bawah ini untuk mengubah data jenis materi.</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('material-types.update', $materialType->id) }}" method="POST">
                @csrf
                @method('PUT')

                <div class="mb-4">
                    <label for="code" class="block text-gray-700 font-semibold mb-2">Kode</label>
                    <input type="text" name="code" id="code" value="{{ old('code', $materialType->code) }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $materialType->name) }}"
