<x-layouts.app>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        ...
        <x-table-toolbar actionUrl="{{ route('batches.index') }}" searchPlaceholder="Cari batch..." />
        ...
        <x-table>
            ...
            <tr class="border-b border-gray-200 hover:bg-gray-50">
                <td class="px-4 py-3 text-sm text-gray-500">{{ $batches->firstItem() + $index }}</td>
                <td class="px-4 py-3 text-sm text-gray-900">{{ $batch->name }}</td>
                <td class="px-4 py-3">
            ...
            @empty
            <tr>
                <td colspan="3" class="px-4 py-8 text-center text-gray-500">Belum ada data Batch.</td>
            </tr>
            @endforelse
        </x-table>
