<x-layouts.app>
    <x-slot:title>Edit Batch</x-slot>
    ...
    <div class="tw-wrap p-6 max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Edit Data Batch</h1>
            <p class="text-gray-600 mt-1">Silakan perbarui form di bawah ini untuk mengubah data batch.</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('batches.update', $batch->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="code" id="code" value="{{ old('code', $batch->code) }}"
                ...
                <div class="mb-4">
                    <label for="name" class="block text-gray-700 font-semibold mb-2">Nama Batch <span
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $batch->name) }}"
                        ...
                        placeholder="Contoh: Batch 1" required>
                    @error('name')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
