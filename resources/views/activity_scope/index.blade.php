...
@section('title', 'Manajemen Cakupan Kegiatan Kegiatan')
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center space-x-2">
                        ...
                        <form action="{{ route('activity-scopes.destroy', $activityScope->id) }}" method="POST"
                            ...
                            <button type="submit"
                                ...
                                onclick="return confirm('Apakah Anda yakin ingin menghapus Cakupan Kegiatan ini?')">
                                Hapus
                            </button>
                        </form>
                    </td>
                ...
                <tr>
                    <td colspan="3" class="px-6 py-10 text-center text-gray-500 text-sm">
                        Belum ada data Cakupan Kegiatan.
                    </td>
                </tr>
                @endforelse
            </tbody>
