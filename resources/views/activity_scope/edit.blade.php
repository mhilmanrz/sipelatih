<x-layouts.app>
    <x-slot:title>Edit Ruang Lingkup</x-slot>
    ...
    <div class="tw-wrap p-6 max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Edit Data Ruang Lingkup</h1>
            <p class="text-gray-600 mt-1">Silakan perbarui form di bawah ini untuk mengubah data ruang lingkup.</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('activity-scopes.update', $activityScope->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="code" id="code" value="{{ old('code', $activityScope->code) }}"
