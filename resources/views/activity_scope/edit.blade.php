...
@section('title', 'Edit Cakupan Kegiatan')
...
<div class="tw-wrap p-6 max-w-2xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Edit Data Cakupan Kegiatan</h1>
        <p class="text-gray-600 mt-1">Silakan perbarui form di bawah ini untuk mengubah data Cakupan Kegiatan.</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('activity-scopes.update', $activityScope->id) }}" method="POST">
            @csrf
            @method('PUT')

            <div class="mb-4">
                <label for="name" class="block text-gray-700 font-semibold mb-2">Nama Cakupan Kegiatan <span
                        class="text-red-500">*</span></label>
                <input type="text" name="name" id="name" value="{{ old('name', $activityScope->name) }}"
