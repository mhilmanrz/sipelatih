<x-layouts.app>
    <x-slot:title>Edit Kategori Pagu</x-slot>
    ...
    <div class="tw-wrap p-6 max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800 border-b pb-2">Edit Kategori Pagu</h1>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('budget-categories.update', $categoryPagu->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-5">
                    <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Nama Kategori Pagu <span class="text-red-500">*</span></label>
                    <input type="text" name="name" id="name" value="{{ old('name', $categoryPagu->name) }}" required
                ...
                <div class="mb-5">
                    <label for="code" class="block text-sm font-medium text-gray-700 mb-2">Kode Kategori Pagu <span class="text-red-500">*</span></label>
                    <input type="text" name="code" id="code" value="{{ old('code', $categoryPagu->code) }}" required
