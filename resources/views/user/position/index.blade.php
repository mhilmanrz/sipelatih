<x-layouts.app>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        ...
        <x-table-toolbar actionUrl="{{ route('positions.index') }}" searchPlaceholder="Cari Kode/Nama Jabatan..." />
        ...
        <x-table>
            ...
            <tr class="border-b border-gray-200 hover:bg-gray-50 transition">
                <td class="px-4 py-3 text-sm text-gray-500 text-center">{{ $positions->firstItem() + $index }}</td>
            ...
            @empty
            <tr>
                <td colspan="4" class="px-4 py-8 text-center text-gray-500">Belum ada data jabatan.</td>
            </tr>
            @endforelse
        </x-table>
