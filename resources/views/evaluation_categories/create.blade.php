            ...
            <form action="{{ route('evaluation-categories.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <select id="evaluation_type" name="evaluation_type"
                        ...
                        <option value="1" @selected(old('evaluation_type') === '1')>Level 1 (Kepuasan Peserta)</option>
                        <option value="3" @selected(old('evaluation_type') === '3')>Level 3 (Penilaian Dampak)</option>
                    </select>
                ...
                <div>
                    ...
                    <select id="form_type" name="form_type"
                        ...
                        <option value="speaker" @selected(old('form_type') === 'speaker')>Narasumber</option>
                        <option value="activity" @selected(old('form_type') === 'activity')>Kegiatan</option>
                    </select>
                    @error('form_type')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
