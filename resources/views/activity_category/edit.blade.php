<x-layouts.app>
    <x-slot:title>Edit Kategori Kegiatan</x-slot>
    ...
    <div class="tw-wrap p-6 max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Edit Data Kategori Kegiatan</h1>
            <p class="text-gray-600 mt-1">Silakan perbarui form di bawah ini untuk mengubah data Kategori Kegiatan.</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('activity-categories.update', $activityCategory->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="code" id="code" value="{{ old('code', $activityCategory->code) }}"
                ...
                <div class="mb-4">
                    <label for="name" class="block text-gray-700 font-semibold mb-2">Nama Kategori Kegiatan <span
                            class="text-red-500">*</span></label>
                    <input type="text" name="name" id="name" value="{{ old('name', $activityCategory->name) }}"
